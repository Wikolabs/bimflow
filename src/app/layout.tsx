...
export const metadata: Metadata = {
  title: "BIMFlow — Votre maquette numerique analysee automatiquement",
  description: "BIMFlow ingere vos fichiers IFC et nuages de points, extrait les informations geometriques et livre des donnees structurees exploitables. Agent IA BIM pour la construction.",
};
