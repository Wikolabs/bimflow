...
export const metadata: Metadata = {
  title: "BIMFlow, Votre maquette numerique analysée automatiquement",
  description: "BIMFlow ingere vos fichiers IFC et nuages de points, extrait les informations geometriques et livre des données structurees exploitables. Agent IA BIM pour la construction.",
};
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="fr" className={`${display.variable} ${body.variable}`}>
      ...
      <body style={{ margin: 0, fontFamily: "var(--font-body),'Plus Jakarta Sans',sans-serif", background: "#1A1420" }}>
        {children}
